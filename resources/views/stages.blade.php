                                    ...
                                    <div class="max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
                                        <div class="flex justify-between items-center">
                                            <span class="font-light text-gray-600">
                                                {{ $stage->created_at->format('d M, Y') }}</span><a href="#" class="px-2 py-1 bg-gray-600 text-gray-100 font-bold rounded hover:bg-gray-500">Laravel</a>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center mt-4">
                                            ...
                                            <form id="ajaxform">
                                                ...
                                                @endforeach
                                                @if($isPresent==true)
                                                <a class="postuleDelete" href="" class="text-blue-500 hover:underline" data-id="{{ $stage->id_stage }}">
                                                    En attente
                                                </a>
                                                @else
                                                <a class="postuleStore" href="" class="text-blue-500 hover:underline" data-id="{{ $stage->id_stage }}">
                                                    Postulez
                                                </a>
                                                @endif
                                                @else
                                            ...
                                            @endif
                                            <div><a href="#" class="flex items-center"><img src="{{ $stage->entreprise->user['profile_photo_url'] }}" alt="{{ $stage->entreprise->user['email'] }}" class="mx-4 w-10 h-10 object-cover rounded-full hidden sm:block">
