            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                            ...
                            <div class="w-full lg:w-12/12">
                                ...
                                <div class="mt-6">
                                    <div class="max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
                                        <div class="flex justify-between items-center"><span class="font-light text-gray-600">{{ $postule->stage->created_at->format('d M, Y') }}</span><a href="#" class="px-2 py-1 bg-gray-600 text-gray-100 font-bold rounded hover:bg-gray-500">Laravel</a>
                                        </div>
                                        ...
                                        <div class="flex justify-between items-center mt-4">
                                            <form id="ajaxform">
                                                <a class="postuleDelete" href="" class="text-blue-500 hover:underline" data-id="{{ $postule->stages['id_stage'] }}">
                                                    En attente
                                                </a>
                                            </form>
                                            <div><a href="#" class="flex items-center"><img src="{{ $postule->stage->entreprise->user['profile_photo_url'] }}" alt="{{ $postule->stage->entreprise->user['email'] }}" class="mx-4 w-10 h-10 object-cover rounded-full hidden sm:block">
                                            <h1 class="text-gray-700 font-bold hover:underline">{{ $postule->stage->entreprise->user['email'] }}</h1>
                                                </a></div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="flex bg-gray-100 py-24 justify-center">
                    <div class="text-center w-2/4">
                        <div class="md:text-3xl text-3xl font-medium">Aucunes candidatures en attentes</div>
                        <div class="text-xl font-normal mt-4">Vous n'avez pas encore de candidature en attente, n'attendez plus et commencez à postulez dès
                            aujourd'hui.
                        </div>
